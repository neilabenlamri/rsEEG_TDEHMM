...
final_model.save("/mnt/uphummel/scratch/nbenlamr/osl_results/Results_HMM_bestconfig_left_lesion_2")
#to save the grid search results
with open("/mnt/uphummel/scratch/nbenlamr/osl_results/grid_search_results_left_lesion_2.pkl", "wb") as f:
